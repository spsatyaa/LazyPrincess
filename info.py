...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('1371853607', '').split()]
...
# LOG CHANNELS *
LOG_CHANNEL = int(environ.get('-1001976618811', 0))
LAZY_GROUP_LOGS = int(environ.get('-1001950093576', 0))
REQ_CHANNEL = int(environ.get('https://t.me/FilmyDosesbot'))
PRIME_MEMBERS_LOGS = int(environ.get('https://t.me/FilmyDosesbot'))
...
# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/FilmyDosesbot') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Filmydosesofficial')
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Filmydosesbot'True) # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','Filmy_Doses') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','Filmydosesofficial') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','Filmydosesbot')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', '+tDGEI-d6mwgyMTI1") #[ without @ ]
...
DOWNLOAD_TEXT_URL = "https://t.me/Filmydosesofficial"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Filmy_Doses"
